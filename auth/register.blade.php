...
<body class="flex h-screen overflow-hidden bg-gray-50 font-sans">

  <div class="hidden lg:flex lg:w-1/2 items-center justify-center bg-[#133E87] p-8">
  ...
  <div class="w-full lg:w-1/2 h-full overflow-y-auto bg-white flex items-start justify-center pt-12 px-6 pb-6">
    <div class="w-full max-w-2xl bg-white px-6 md:px-16 py-10 rounded-2xl shadow-xl">
