    ...
    <div class="w-full max-w-2xl bg-white px-16 py-10 rounded-2xl shadow-xl">
      ...
      <div class="mb-5">
        ...
        <div class="flex justify-center gap-14 mb-5">
          <div class="role-btn active flex flex-col items-center px-14 py-1 rounded-lg border border-gray-300 bg-blue-600 text-white font-medium cursor-pointer transition hover:bg-blue-700" onclick="selectRole(this, 'student')">
            <div class="text-3xl mb-2">👨‍🎓</div>
            <div class="text-base">Student</div>
          </div>
          <div class="role-btn flex flex-col items-center px-14 py-1 rounded-lg border border-gray-300 bg-gray-100 text-gray-700 font-medium cursor-pointer transition hover:bg-gray-200" onclick="selectRole(this, 'instructor')">
            <div class="text-3xl mb-2">🧑‍🏫</div>
        ...
        <form method="POST" action="route('login')" class="space-y-4">
          ...
          <div>
            ...
            <input type="email" name="email" required autofocus placeholder="Enter your Gmail address" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>

          <div class="mb-1">
            <label class="block mb-1 text-sm font-semibold text-gray-700">Password</label>
            <input type="password" name="password" required autocomplete="current-password" placeholder="Enter your password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
          ...
          <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition font-semibold">Log in</button>
